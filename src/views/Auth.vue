...
<template>
  <section v-if="!auth.firebaseUser.value" class="container mx-auto">
    ...
    <note-card v-if="oldAuth != null" color="orange">
      ...
      <a
        ...
        href="mailto:contact@ropescore.com"
        target="_blank"
      >contact@ropescore.com</a>
      with the email you used to register as well as the System ID of
