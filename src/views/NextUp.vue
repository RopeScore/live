...
import { useGroupEntriesQuery, useGroupInfoQuery, useHeatChangedSubscription, useHeatEntriesQuery } from '../graphql/generated'
...
const nextTwo = computed(() => {
  return [heatPlusN(1), heatPlusN(2)].filter(n => typeof n === 'number')
})
